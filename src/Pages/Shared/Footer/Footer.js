        ...
        <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    <Link className="btn btn-ghost normal-case font-bold lg:text-4xl text-2xl flex content-center ">
                        <img src={Logo} alt="" className='w-12 mt-4 lg:mx-3' /> <div>Akadimia</div></Link>
                    <p><span className='text-lg'>Akadimia Company Ltd.</span> <br />Providing reliable tech since 1992 <br /> <small>Copyright © All rights reserved by Mohiuddin Khan</small></p>
                </div>
